...
> **在线访问地址**: https://3000-id365cg9s6w6j5eu9rzey-b237eb32.sandbox.novita.ai
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  Model Hub - AI 模型接入管理平台              当前时间: 10:30:15     │
└─────────────────────────────────────────────────────────────────────┘

┌─────────────┬─────────────┬─────────────┬─────────────┐
│ 今日调用次数 │ Token 消耗量 │  总费用      │  成功率      │
│             │             │             │             │
│    156      │   45.2K     │   ¥1.26     │   98.7%     │
│   ━━━━      │   ━━━━      │   ━━━━      │   ━━━━      │
│  📊 +12%    │  📈 +8%     │  💰 +5%     │  ✅ -0.2%   │
...
│                │  │                │  │                │
│ 🔗 直连原厂     │  │ 🔗 直连原厂     │  │ 🔗 直连原厂     │
│ openai         │  │ anthropic      │  │ xunfei         │
│ 3 个模型        │  │ 3 个模型        │  │ 2 个模型        │
│ 优先级: 10      │  │ 优先级: 9       │  │ 优先级: 8       │
│                │  │                │  │                │
│ 🟢 运行中       │  │ 🟢 运行中       │  │ 🟢 运行中       │
│                │  │                │  │                │
│ [查看模型] [编辑] │  │ [查看模型] [编辑] │  │ [查看模型] [编辑] │
└────────────────┘  └────────────────┘  └────────────────┘
...
┌─────────────────┐ ┌─────────────────┐ ┌─────────────────┐
│ 🌐 全局默认      │ │ 💬 客服对话      │ │ ✍️ 内容生成      │
│ default         │ │ customer-service│ │ content-gen     │
│ ━━━━━━━━━━━━━━  │ │ ━━━━━━━━━━━━━━  │ │ ━━━━━━━━━━━━━━  │
│ 调用: 1,200 次   │ │ 调用: 800 次     │ │ 调用: 500 次     │
│ 费用: ¥35.60    │ │ 费用: ¥15.30    │ │ 费用: ¥45.20    │
│ Token: 500K/300K│ │ Token: 200K/150K│ │ Token: 300K/400K│
│ 响应: 1245ms    │ │ 响应: 980ms     │ │ 响应: 1890ms    │
│ [■■■■■■■■■░] 40%│ │ [■■■■░] 18%     │ │ [■■■■■░] 22%    │
└─────────────────┘ └─────────────────┘ └─────────────────┘
...
│ ━━━━━━━━━━━━━━  │ │ ━━━━━━━━━━━━━━  │ │ ━━━━━━━━━━━━━━  │
│ 调用: 300 次     │ │ 调用: 200 次     │ │ 调用: 150 次     │
│ 费用: ¥8.90     │ │ 费用: ¥12.30    │ │ 费用: ¥5.80     │
│ [■■░] 10%       │ │ [■■░] 12%       │ │ [■░] 8%         │
└─────────────────┘ └─────────────────┘ └─────────────────┘

【按厂商费用统计 - Top 5（最近 30 天）】
┌─────────────────────────────────────────────────────────────────────┐
│ 厂商      │ 调用次数 │ Input/Output Tokens │  总费用  │ 费用占比   │
├─────────────────────────────────────────────────────────────────────┤
│ OpenAI   │  3,000  │ 1.5M / 0.75M       │  ¥89.50 │ [■■■■■■■] 60% │
│ Anthropic│  1,000  │ 800K / 400K        │  ¥45.30 │ [■■■■] 30%   │
│ 讯飞星火  │    500  │ 300K / 200K        │  ¥12.80 │ [■■] 10%     │
└─────────────────────────────────────────────────────────────────────┘
```
...
【调用日志 - 最近 30 条】（支持筛选：时间、场景、厂商、模型、状态）
┌─────────────────────────────────────────────────────────────────────┐
│ 时间      │ 场景   │ 模型      │ Token(I/O) │ 费用  │ 响应时间 │ 状态 │
├─────────────────────────────────────────────────────────────────────┤
│ 10:30:15 │ 💬 客服 │ GPT-3.5  │ 150/200   │ ¥0.08│ 1234ms  │ ✅ 成功│
│ 10:28:42 │ ✍️ 内容 │ GPT-4    │ 500/800   │ ¥1.45│ 2156ms  │ ✅ 成功│
│ 10:25:11 │ 🌍 翻译 │ Claude 3 │ 300/400   │ ¥0.52│ 1567ms  │ ✅ 成功│
│ 10:20:33 │ 💬 客服 │ GPT-3.5  │ 200/250   │ ¥0.10│  980ms  │ ✅ 成功│
│ 10:15:22 │ 📊 分析 │ GLM-4    │ 400/600   │ ¥0.35│ 1890ms  │ ✅ 成功│
│ ...                                                                  │
└─────────────────────────────────────────────────────────────────────┘

[<< 上一页]   第 1 页 / 共 75 页   [下一页 >>]
```

---

#### 页面 5：场景路由（Model Switch）
...
│                       │  │                       │
│ 当前模型:              │  │ 当前模型:              │
│ [OpenAI Logo] GPT-3.5 │  │ [Anthropic] Claude 3  │
│ 🔗 直连原厂            │  │ 🔗 直连原厂            │
│                       │  │                       │
│ 计费信息:              │  │ 计费信息:              │
│ Input:  $0.0005/1K   │  │ Input:  $0.015/1K    │
│ Output: $0.0015/1K   │  │ Output: $0.075/1K    │
│                       │  │                       │
│ 最后更新: 2 小时前      │  │ 最后更新: 1 天前       │
│                       │  │                       │
│   [切换模型]           │  │   [切换模型]           │
└───────────────────────┘  └───────────────────────┘
...
【切换历史记录 - 最近 20 条】
┌─────────────────────────────────────────────────────────────────────┐
│ 时间         │ 场景标签 │ 切换内容         │ 原因     │ 操作人 │ 状态 │
├─────────────────────────────────────────────────────────────────────┤
│ 02-26 10:30 │ 💬 客服  │ GPT-4 → GPT-3.5 │ 成本优化 │ 张三  │ ✅ 成功│
│ 02-25 15:20 │ ✍️ 内容  │ GPT-4 → Claude  │ 性能优化 │ 李四  │ ✅ 成功│
│ 02-25 09:15 │ 🌍 翻译  │ GPT-3.5 → Claude│ 功能升级 │ 王五  │ ✅ 成功│
│ 02-24 16:45 │ 📊 分析  │ GPT-4 → GLM-4   │ 测试验证 │ 张三  │ ✅ 成功│
└─────────────────────────────────────────────────────────────────────┘
```

**关键特性**（v1.2）：
- **场景卡片**：6 个业务场景，2 行 3 列
- **配置信息**：
  - 当前使用的模型（带厂商 Logo）
  - 接入类型徽章
  - 计费价格（Input/Output）
  - 最后更新时间
- **未配置状态**：显示占位提示和"立即配置"按钮
- **切换历史**：
  - 时间线形式
  - 显示场景 Emoji 标签
  - 切换内容（原模型 → 目标模型）
...
```
┌─────────────────────────────────────────────────────────────┐
│  Step 1: 点击场景卡片的"切换模型"按钮                        │
└─────────────────────────────────────────────────────────────┘
                           ↓
┌─────────────────────────────────────────────────────────────┐
│  Step 2: 弹出模态框 - "切换模型 - 客服对话"                  │
│                                                             │
│  ┌───────────────────────────────────────────────────────┐ │
│  │ 选择目标模型（表格）                                   │ │
│  ├───────────────────────────────────────────────────────┤ │
